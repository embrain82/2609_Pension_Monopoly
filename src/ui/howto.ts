...
export function renderHowToModal(characters = true): string {
  return `<p class="eyebrow">처음 한 번만 보여 줍니다</p>
    ...
    <ol class="howto-steps">
      ...
      <li><b>3</b><div><strong>먼저 납입, 그다음 매수</strong><p>기존계좌 시작 시 대기자금은 0원입니다. 납입·매도·만기 결제로 매수 자금을 마련하세요. 신규가입 체험은 초기입금이 대기자금으로 준비됩니다. 주식 ETF는 적극투자형·공격투자형 진단 뒤에만 살 수 있습니다. 납입의 세액공제는 연말정산 칸을 지날 때 생활자금으로 돌아옵니다.</p></div></li>
